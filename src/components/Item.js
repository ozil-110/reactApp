                    ...
                    <Content style={{marginRight:'20px',minHeight:'600px'}}>
                        <Layout style={{backgroundColor:'white',padding:'15px'}}>
                            <Header style={{backgroundColor:'white',minHeight:'120px',padding:'0px',borderBottom:'1px solid #EDEDED'}}>
                                ...
                                <br/>
                                <span><span style={{fontSize:'bold',color:'red',marginRight:'5px'}}>发布</span>{item.time.minute} <span style={{fontSize:'bold',color:'red',marginRight:'5px'}}>作者</span>{item.author}
                                </span>
                            </Header>
                            ...
                            <Footer style={{padding:'0'}}>
                                ...
                                <div>
                                    <h3 style={{marginBottom:'10px'}}>{this.state.discussions.length}条回复</h3>
                                ...
                                user.name && <div style={{marginTop:'10px'}}>
                                    <h3 style={{marginBottom:'10px'}}>添加回复</h3>
                                    <Input type="textarea" ref="content" autosize={{minRows:10}} onChange={(e)=>this.setState({content: e.target.value})}>
                                    </Input>
                                    <Button type="primary" onClick={this.handleClick}  style={{marginTop:'10px'}}>回复</Button>
                                </div>
                                }
                            </Footer>
                        </Layout>
